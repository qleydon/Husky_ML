...
class SACAgent:
    ...
    def load_models(self,file_path):
        self.critic_local.load_state_dict(torch.load(file_path+"\\critic_local"))
        self.critic_local2.load_state_dict(torch.load(file_path+"\\critic_local2"))
        self.actor_local.load_state_dict(torch.load(file_path+"\\actor"))
        self.critic_target.load_state_dict(torch.load(file_path+"\\t_critic_local"))
        self.critic_target2.load_state_dict(torch.load(file_path+"\\t_critic_local2"))
